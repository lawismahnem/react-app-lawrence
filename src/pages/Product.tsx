  ...
  return (
    <div className="container p-0 mt-10 border-l border-r border-b rounded grid grid-cols-3">
      ...
      <div className="border-l p-6 flex flex-col">
        <button className="bg-indigo-500 text-white hover:bg-indigo-600 font-bold rounded shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,1)] focus:outline-none border-gray-900 hover:border-gray-900 border-2">
          {" "}
          Buy now
        </button>
      </div>
